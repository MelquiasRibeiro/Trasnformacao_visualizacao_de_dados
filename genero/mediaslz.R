...
ggplot(aes(x =`Variável`, y = Valor, fill =`Variável`)) + 
  ...
  labs(x="Ano", y="quantidade de pessoas", title="Media da Razão de Homens e Mulheres empregados em todos o principais setores de São Luis",
